...
export default class Board {
  ...
  addFigures() {
    const splitedPosition = this.game.name === STRINGS.chess ? START_POSITION.positionChess.split('/') : START_POSITION.positionCheckers.split('/');
  ...
  changeSrc(){
    if(STRINGS.whiteKingSrc.includes(this.turnMove)) {
      this.turnMoveImage.src = this.game.name === STRINGS.chess ? STRINGS.whiteKingSrc: STRINGS.whiteCheckerSrc;
    } else this.turnMoveImage.src = this.game.name === STRINGS.chess ? STRINGS.blackKingSrc: STRINGS.blackCheckerSrc;
  }
  ...
  showTransModal() {
    return new Promise((resolve) => {
      ...
      const transButtons = Array.from(document.querySelectorAll('.transformation-button'));
  ...
  checkWin(){
    this.game.name === STRINGS.chess ? this.checkWinForChess() : this.checkWinForCheckers()
